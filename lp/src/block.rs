...
impl<'a> PartialEq for CursorPosition<'a> {
    fn eq(&self, rhs: &CursorPosition<'a>) -> bool {
        match (&self, &rhs) {
...
mod guacamole {
    ...
    fn human_guacamole_2() {
        ...
        assert_eq!(
            Some("xdQPKOyZwQUykR8iVbMtYMhEaiW3jbrS5AKqteHkjnRs2Yfl4OOqtvVQKqojsB0a".as_bytes()),
            got.value
        );
        assert_eq!(
            CursorPosition::Positioned {
